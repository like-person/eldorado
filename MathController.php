...
class MathController extends Controller {
    ...
    public function results() {
        ...
        /*Задача №3*/
        //Алгоритм 
        //1)Разделяем слово пополам 
        //2) Символы в половинках делаем в обратном порядке 
        //3) Объединяем полученные половинки в обратном порядке и между ними ставим средний символ, 
            //если в слове нечетное количество символов. 
        //4) Полученное слово: результат
        $word = 'test_word';
